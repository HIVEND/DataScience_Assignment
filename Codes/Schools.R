...
write.csv(SchoolData, "Clean/Combined_School_Data.csv",row.names = FALSE)
...
write.csv(CleanedSchoolData, "Clean/Cleaned_School_Data.csv",row.names = FALSE)


Post=read.csv("Clean/Combined_House_Pricing_2019-2022.csv") %>% 
...
write.csv(OXFORSSHIRESchoolData, "Clean/OXFORSSHIRESchoolData.CSV",row.names = FALSE) 
...
write.csv(YORKSHIRESchoolData, "Clean/YORKSHIRESchoolData.CSV",row.names = FALSE) 

...
House_price = read_csv("clean/Cleaned_House_Pricing_2019-2022.csv")
...
speed_downloads = read_csv("clean/Cleaned_Broadband_Speed.csv")
...
#crime score rank
crime_score=read_csv("clean/Cleaned_Crime_Data.csv")
...
#school score
school_score=read_csv("clean/Cleaned_School_Data.csv")
